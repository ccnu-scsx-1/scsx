...
/**resume feedback**/
export const SAVE_RESUME_FEEDBACK_SUCCESS = 'SAVE_RESUME_FEEDBACK_SUCCESS'
export const SAVE_RESUME_FEEDBACK_FAIL = 'SAVE_RESUME_FEEDBACK_FAIL'

/**update register**/
export const LOAD_REGISTER_INFO_SUCCESS = 'LOAD_REGISTER_INFO_SUCCESS'
export const LOAD_REGISTER_INFO_FAIL = 'LOAD_REGISTER_INFO_FAIL'
...
/**invite detail*/
export const LOAD_INVITE_DETAIL_SUCCESS = 'LOAD_INVITE_DETAIL_SUCCESS'
export const LOAD_INVITE_DETAIL_FAIL = 'LOAD_INVITE_DETAIL_FAIL'